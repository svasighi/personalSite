...
function App() {
  ...
  return (
    <div className="container flex space-x-7 justify-between py-16 h-screen box-border mx-auto">
      <div>
      ...
      {/* picture */}
      <div className="w-96 pb-12 relative">
      ...
      <div
        ref={ref}
        className="flex-1 text-gray-900 h-auto text-white overflow-auto">
